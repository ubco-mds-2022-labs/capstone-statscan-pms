...
mylog <- mylog %>% add_row(week = current.week,
                       ...
                       comments="Code of Conduct and Team contract"
                       )
...
mylog <- mylog %>% add_row(week = current.week,
                       day=as.Date("2023-04-16"), 
                       hours=2,
                       description="Brainstorming meeting with Firas",
                       comments="Changed marking schemes and edited rubrics"
                       )
