...
ggsave("original_distribution_prieduc.png", (t[[1]]+xlim(0,1)+ggtitle(' ')), dpi = 400, width=2, height=2)
ggsave("log_distribution_prieduc.png", (t[[2]]+xlim(-5,0)+ggtitle(' ')), dpi = 400, width=2, height=2)
