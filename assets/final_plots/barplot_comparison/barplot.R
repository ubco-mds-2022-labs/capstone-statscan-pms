...
all_cutoffs = list(cut_offs_mclust, cut_offs_quintile, cut_offs_hdbscan, cut_offs_manual)
all_cutoffs = lapply(all_cutoffs, function(x) lapply(x,sort))

approaches = c('MCLUST', 'Quintile', 'HDBSCAN', 'Min/Max')
