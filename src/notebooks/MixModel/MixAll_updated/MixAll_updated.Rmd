...
ammenities <- c("PMS_prox_idx_educpri", "PMS_prox_idx_emp")
...
```{r}
write.csv(results_df, "res_df.csv", row.names = FALSE)
```
...
optimal_num_clusters <- function(amenity, results_df) {
  ...
  best_num_clusters <- which.max(scores)
