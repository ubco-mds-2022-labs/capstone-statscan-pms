---
title: "MixAll (PMS + log transform (no other variables))"
author: "PMS"
...
#commenting out the variables so only using the single PMS
...
do_everything = function(dataset, amen_name, num){
  ...
  #calling cutoff function
  cutoffs <- compute_cutoffs(comp_data, clusts)
  ...
  return(list('amenity' = amen_name, 'cutoffs' = cutoffs))
}
```
