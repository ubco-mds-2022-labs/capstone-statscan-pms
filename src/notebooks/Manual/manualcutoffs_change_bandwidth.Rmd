---
title: "Manual cutoffs: adjust bw"
...
for (amen in amenities){
  ...
  count <- count+1
  amen_list <- list()
  amen_list[[1]] <- density(master_log[,amen], adjust = 1/2, na.rm = T) # list of densities
  d_amen <-  density(master_log[,amen],adjust = 1/2, na.rm = T)
...
```{r, eval = F}
d_amen <-  density(master_log[,8],adjust = 1/2, na.rm = T)
