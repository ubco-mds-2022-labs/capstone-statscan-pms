...
do_everything = function(dataset, amen_name, num){
  ...
  # Plot cluster data points and center named by cluster number
  fviz_cluster(cluster_data, cluster_assignments, main = "Cluster Data Points") +
    geom_text(aes(label = as.character(cluster_assignments)), size = 4, color = "black")
