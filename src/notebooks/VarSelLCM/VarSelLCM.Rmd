...
all_cutoffs_emp = append(all_cutoffs_emp, lst_emp)
```
...
all_cutoffs_health = append(all_cutoffs_health, lst_health)
```
...
all_cutoffs_childcare = append(all_cutoffs_childcare, lst_childcare)
```
...
all_cutoffs_parks = append(all_cutoffs_parks, lst_parks)
```
