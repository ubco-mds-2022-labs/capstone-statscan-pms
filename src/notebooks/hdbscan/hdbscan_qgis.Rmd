...
master <- master[master$PRNAME %in% c("British Columbia / Colombie-Britannique"), ]
# master <- master[complete.cases(master$PMS_prox_idx_pharma), ]
...
do_everything = function(dataset, amen_name, num){
  ...
  #export data
  save(amen, file = paste0(amen_name, '_qgis.Rdata'))
  rm(res)
